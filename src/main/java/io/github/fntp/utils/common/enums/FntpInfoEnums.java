...
public enum FntpInfoEnums {
     ...
     */
    FntpInfoEnums(String enumsStringValue) {
     ...
     */
    FntpInfoEnums(Integer enumsIntegerValue) {
    ...
    FntpInfoEnums(String enumsStringValue, Integer enumsIntegerValue) {
        this.enumsStringValue = enumsStringValue;
        this.enumsIntegerValue = enumsIntegerValue;
    }
